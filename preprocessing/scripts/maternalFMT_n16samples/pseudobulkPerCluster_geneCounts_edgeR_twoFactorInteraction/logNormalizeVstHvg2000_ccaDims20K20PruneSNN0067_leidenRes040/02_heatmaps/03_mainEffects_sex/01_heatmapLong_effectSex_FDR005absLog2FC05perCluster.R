...
# ==============================================================================
# 01_heatmapLong_effectSex_FemaleVsMale_FDR005absLog2FC05perCluster.R
#
# Long heatmap for the main sex effect from the cluster-specific pseudobulk
# edgeR two-factor analysis.
#
# TEST
...
row_clustering_same_cluster_bonus <- 0.2
...
message(
  "Sex main-effect long heatmap completed successfully."
)
