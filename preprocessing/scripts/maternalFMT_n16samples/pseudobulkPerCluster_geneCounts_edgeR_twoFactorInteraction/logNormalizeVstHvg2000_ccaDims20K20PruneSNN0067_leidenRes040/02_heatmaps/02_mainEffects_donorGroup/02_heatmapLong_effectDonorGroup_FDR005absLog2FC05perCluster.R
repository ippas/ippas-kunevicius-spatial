...
# ==============================================================================
# 02_heatmapLong_effectDonorGroup_FDR005absLog2FC05perCluster_maxPctSeries_v4.R
#
# Series of five long heatmaps for the main FMT donor-group effect from the
# cluster-specific pseudobulk edgeR two-factor analysis.
#
# SELECTION
#   FDR < 0.05
#   abs(log2FC) >= 0.5
...
results_per_cluster_tsv <- file.path(
  ...
  paste0(
    ...
    "_effectDonorGroup_",
    parameter_block,
    "_maxPctSeries_resultsPerCluster.tsv"
  )
)
...
# ==============================================================================
# 17. Write combined results-per-cluster table
# ==============================================================================
...
# ==============================================================================
# 18. Validate outputs and final report
# ==============================================================================
