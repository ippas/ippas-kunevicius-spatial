...
# ==============================================================================
# 03_pseudobulk_edgeR_allHeatmaps_all16samples.R
#
# PURPOSE
...
#   <analysis_directory>/heatmaps
#
# Missing analysis directories are skipped with a warning. This allows the same
# script to be used before or after both edgeR variants have been completed.
# ==============================================================================
...
# ==============================================================================
# 15. Run the common heatmap workflow for all available analysis subfolders
# ==============================================================================
...
message(
  "ALL REQUESTED HEATMAP WORKFLOWS COMPLETED SUCCESSFULLY"
)
