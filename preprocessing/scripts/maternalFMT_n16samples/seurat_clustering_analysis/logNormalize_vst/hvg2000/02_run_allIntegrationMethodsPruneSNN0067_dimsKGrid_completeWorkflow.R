# ==============================================================================
# 02_run_allIntegrationMethodsPruneSNN0067_dimsKGrid_completeWorkflow.R
#
...
#
# Grid:
# - integration dimensions: 20, 30, 40 and 50;
...
main <- function() {
  ...
  grid_prefix <-
    "02_allIntegrationMethodsPruneSNN0067_dims20to50_k20to50"
  ...
  if (
    ...
    stop(
      "`functions_integration_neighborsGraph.R` is not the universal ",
